...
export default function WorkOrderCreateUpdateOnPageLoad(context) {
    ...
    return GetWOGeometryDateFromPrevPageBinding(context).then(geometryData => SetWOCreateUpdateLocationSection(context, geometryData)).then(() => setSoldToPartyPicker(context));
}
